...
export function TestimonialCard({ quote, author, role, company, image, rating = 5 }: TestimonialCardProps) {
  ...
  return (
    <div ref={cardRef} className="group relative p-6 bg-card rounded-xl border border-border hover:border-primary transition-all duration-300 hover:shadow-xl hover:-translate-y-2 overflow-hidden">
