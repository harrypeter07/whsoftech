...
@media screen and (min-width: 576px) {
    .cascade-slider_container { height: 75vh; }
...
@media screen and (min-width: 768px) {
    ...
    .cascade-slider_slides img { max-width: 340px; }
}
...
@media screen and (min-width: 1100px) {
    ...
    .cascade-slider_slides img { max-width: 460px; }
}
`;
...
const ThreeDImageCarousel: FC<ThreeDImageCarouselProps> = ({
    slides,
    itemCount = 5,
    autoplay = false,
    delay = 3,
    ...
    const handleExit = (e: React.MouseEvent) => {
        ...
        // 2. Drag cancellation logic (Equivalent to removed onMouseLeaveDrag)
        if (isDragging) {
            handleEnd(e.clientX);
        }
    };
    ...
    const handleEnd = (clientX: number) => {
        ...
        setIsDragging(false);
        setStartX(0);
        // Autoplay is resumed by useEffect on state change or by handleExit/onMouseUp
    };
