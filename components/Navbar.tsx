        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <button
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = 'translateY(-2px)'; (e.currentTarget as HTMLElement).style.boxShadow = '0 8px 25px rgba(124,58,237,0.45)'; }}
        ...
        {open && (
          <motion.div
            ...
            style={{
              ...
              background: 'rgba(7,7,15,0.98)', backdropFilter: 'blur(24px)',
          ...
          >
            ...
            {NAV_LINKS.map((link, i) => (
              <motion.button
                ...
                style={{
                  ...
                  color: active === link.href ? '#a78bfa' : 'white',
                  fontSize: '1.375rem', fontWeight: 700,
                  fontFamily: 'Space Grotesk, sans-serif',
                  transition: 'color 0.2s', width: '100%', textAlign: 'center',
                }}
              >
                {link.label}
              </motion.button>
            ...
            <motion.button
              ...
              onClick={() => handleNav('contact')}
              style={{
                marginTop: '1.5rem', padding: '1rem 3rem', borderRadius: '0.875rem',
                background: 'linear-gradient(135deg, #7c3aed, #6366F1)',
